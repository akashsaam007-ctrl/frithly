...
export const META = {
  ...
  KEYWORDS:
    "Frithly, buying signals, outbound opportunities, decision maker verification, manual qualification, sales intelligence service, personalized outreach, outbound ready opportunities",
