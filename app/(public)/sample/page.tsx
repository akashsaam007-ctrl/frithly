...
export default function SamplePage() {
  return (
    <main className="relative isolate overflow-hidden bg-[#050505] py-8 text-white sm:py-12 lg:py-16">
      ...
      <Container className="relative">
        <section className="mx-auto max-w-[1200px] px-5 pt-4 pb-14 sm:px-8 lg:px-0 lg:pt-4 lg:pb-20">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.42fr)_minmax(0,0.58fr)] lg:gap-14">
            <div className="pt-3 lg:pt-14">
              <p className="mb-4 text-[0.75rem] font-semibold uppercase tracking-[0.12em] text-[#f1b540]">
                Personalized Sample
              </p>
              <h1 className="max-w-[480px] text-[2.15rem] font-semibold leading-[1.04] tracking-[-0.05em] text-[#f7f7f7] sm:text-[2.6rem] lg:text-[3rem]">
                Request your personalized
                <br />
                lead sample
              </h1>
              <p className="mt-5 max-w-[470px] text-[1rem] leading-[1.75] text-[#a3a3a3] sm:text-[1.0625rem]">
              ...
              <div className="mt-7 max-w-[470px] border-l-2 border-[#f1b540]/85 pl-4 text-[0.82rem] leading-6 text-[#737373]">
        ...
        <section className="mx-auto max-w-[1100px] px-5 pb-12 sm:px-8 lg:px-0 lg:pb-16">
