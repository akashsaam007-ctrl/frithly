...
export const metadata: Metadata = buildPublicMetadata({
  description:
    "Learn how Frithly helps outbound teams find better-fit accounts, the right contacts, and better timing before outreach starts.",
  keywords: [
    "about Frithly",
  ...
  path: "/about",
  title: "About Frithly | Better Outbound Starts With Better Accounts",
});
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-8 text-muted">
                Book a conversation if you already know you need a stronger outbound intelligence
                engine, or send us your brief if you want us to review rollout fit first.
              </p>
            </div>
